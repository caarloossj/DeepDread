...
namespace XNodeEditor {
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node> {
        ...
        /// <summary> Sets color for target node </summary>
        public virtual void SetTint(Color newColor = default(Color)) {
            // Try get color from [NodeTint] attribute
            Node node = target;
            if(object.Equals(newColor, default(Color))) newColor = DEFAULTCOLOR;
            node.TrySetAttributeTint(newColor);
        }
        ...
        public virtual Color GetTint() {
            // Try get color from [NodeTint] attribute
            Node node = target;
            if (node.TryGetAttributeTint(out Color color)) return color;
